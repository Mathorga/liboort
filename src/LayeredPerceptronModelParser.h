...
In order to be parsed from file, a LayeredPerceptronModel needs to be saved in
two files with the same name: one with .mdl extension and the other with
.mdl.lyr extension.
Model Layer files' (.mdl.lyr) specification defines a header made of four bytes,
which define the number of layers for the model.
...
00    00    00    03    00    00    05    10    00    00    00    0A 00    00
00    03
The file contains a layer specification that defines a model with three layers,
respectively of size 00000510 (1296), 0000000A (10) and 00000003 (3).
